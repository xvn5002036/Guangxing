        ...
        <div className="max-w-6xl mx-auto relative">
            ...
            <div className="bg-mystic-charcoal/80 border-4 border-yellow-900/50 rounded-lg p-6 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden min-h-[600px] flex flex-col items-center">
                ...
                <div className="relative mb-12 group">
                    ...
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-yellow-500/20 rounded-full blur-[60px] transition-opacity duration-1000 ${isDeityGlowing ? 'opacity-100' : 'opacity-20'}`}></div>
                    
                    {/* Deity Image Frame */}
                    <div className={`relative w-40 h-56 md:w-48 md:h-64 rounded-t-full border-4 ${isDeityGlowing ? 'border-yellow-400 shadow-[0_0_30px_rgba(255,215,0,0.6)]' : 'border-gray-700'} overflow-hidden bg-black transition-all duration-1000 z-10`}>
                        <img 
                            src={siteSettings.deityImage} 
                            alt="Main Deity" 
                            className={`w-full h-full object-cover transition-all duration-1000 ${isDeityGlowing ? 'brightness-110 contrast-110' : 'brightness-50 grayscale'}`}
                        />
                         {/* Shine overlay */}
                    ...
                    {/* Altar Base */}
                    <div className="w-56 md:w-64 h-8 bg-gradient-to-b from-yellow-900 to-black rounded-sm mx-auto mt-1 border-t border-yellow-700 relative z-20">
                        <div className="text-center text-[10px] text-yellow-500 font-bold tracking-[0.5em] pt-1.5">
