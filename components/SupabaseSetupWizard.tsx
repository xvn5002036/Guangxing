            ...
            <div className="flex gap-6">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="bg-black/40 border border-white/5 p-4 rounded text-gray-300 text-sm leading-relaxed space-y-2">
                        ...
                        <p>3. 找到 <span className="text-white font-bold">Project URL</span> (已設定為 <code className="text-green-400">gmswwklptwtxceomjrbm...</code>)</p>
                        <p>4. 複製 <span className="text-white font-bold">anon public key</span>。</p>
                        <p>5. 打開 <code className="bg-gray-800 px-2 py-1 rounded text-orange-300">services/supabase.ts</code> 檔案，將 Key 填入 <code className="text-white">SUPABASE_KEY</code> 變數。</p>
                    </div>
                </div>
            </div>
